...
void DetectionOutputLayer<Dtype,Mtype>::Forward_gpu(
  ...
  LOG(INFO) << "DetectionOutput Prepare:" << float(clock() - start_clock_decode )/ (CLOCKS_PER_SEC / 1000) ;
